...
def execute_wncli(working_dir, override_args_dict, dem_path, forecast, shp, asc, wxshp):
    ...
    cli["initialization_method"] = "domainAverageInitialization" if (forecast == "NONE") else "wxModelInitialization"
...
if __name__ == "__main__":
    ...
    override_args = {ptr.split(":")[0]: ptr.split(":")[1] for ptr in "forecast_duration:6;vegetation:trees;mesh_choice:fine".split(";")}
    demPath = r"T:\temp\wn_examples\1a111111111111111111111111111111\wncli\dem.tif"
    forecast = "NOMADS-NAM-CONUS-12-KM"
    result = execute_wncli(wncli_folder, override_args, demPath, forecast, True, True, True)
    print(result)
